...
public abstract class NfcDetectActivity extends AppCompatActivity {
    ...
    private static final String TAG = NfcDetectActivity.class.getName();
    ...
    public void processIntent() {
        ...
        if (scanOn) {
            Log.d(TAG, "Process Intent " + intent.getAction());
